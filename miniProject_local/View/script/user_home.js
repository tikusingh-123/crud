   ...
   $.ajax({
       ...
       success: function (response) {
        ...
        response.forEach(element => {
            ...
            let quizDom = "<div class='col-md-4 col-sm-6 col-xs-12 col-lg-3 p-2 divAlign'><div class='card card-body peopleCarouselImg card-transition'><img class='img-fluid' src='"+element.img+"'><span class='overlay'></span><h2>"+element.name+"</h2> <br> <h4> <button class='btn text-white ' onclick='startQuiz(this);'  value='"+ element.id+","+element.name+"'> Start </button>  <h4></div></div> </div>";
